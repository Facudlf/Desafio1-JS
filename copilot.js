...
// Promedio entero de números con 6 dígitos
let sum = 0;
let count = 0;
for (const number of numbers) {
...
console.log('Arreglo de contadores según el anteúltimo dígito:', digitCounts);
...
console.log('Promedio entero de números con 6 dígitos:', average);